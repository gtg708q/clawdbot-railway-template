...
Notes:
- This template pins OpenClaw to a released npm version by default via Docker build arg `OPENCLAW_VERSION` (see the Dockerfile; bump the default there, or set the build arg on Railway, to upgrade).
